...
>
	...
	<a href="./index.html"><span>Domicile</span></a>
	...
	<a href="./index.html"><span>Domicile</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<a href="./sitemap.xml"><span>Index de plan de site</span></a>
						<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
	...
	<div id="content-head">
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				et a été généré le 16 mai 2025 à 1h28			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="./index.html"><span>Domicile</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="./index.html" class="button">Revenir à la page d’accueil</a>
					</div>
